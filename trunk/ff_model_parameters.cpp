...
// Space
double volume_reduce = 0.9 * 0.5 * 0.25; //0.25; // 0.09; //0.085; // 0.1862; // initial density set
...
double k_o = 0.5; // 1E-1 * 0.5; // 5E-4 - same result //0.1; // Level of coverage of surface by the oleic acid
