...
// Space
double volume_reduce = 0.25; // 0.09; //0.085; // 0.1862; // initial density set
...
double delta_r = a0; // minimal distance between particles 
...
const double dt0 = 1.7E-9; //1E-1 * dt_neel; // 1E2 * dt_neel; // 100 * dt_neel; // s // old approach 1.5E-5
...
double k_o = 1E-5; // 5E-4 //0.1; // Level of coverage of surface by the oleic acid
