...
ControlView::ControlType ControlView::type() const
{
    return m_type;
}

QPixmap ControlView::pixmap() const
{
    return m_pixmap;
}

QString ControlView::text() const
{
    return m_text;
}

void ControlView::setText(const QString &t)
{
    m_text = t;
    update();
}

void ControlView::setPixmap(const QPixmap &p)
{
    m_pixmap = p;
    update();
}

void ControlView::setType(ControlType t)
{
    m_type = t;
    update();
}
...
void ControlView::updateCtrlPoints(const QPolygonF &points)
{
...
void ControlView::setVectorType()
{
    m_type = VectorType;
    update();
}

void ControlView::setPixmapType()
{
    m_type = PixmapType;
    update();
}

void ControlView::setTextType()
{
    m_type = TextType;
    update();
}

void ControlView::setAnimation(bool animate)
{
    /*timer.stop();
    if (animate)
        timer.start(25, this);*/
...
void ControlView::changeRotation(int r)
{
    setRotation(qreal(r) / 10);
}

void ControlView::changeScale(int s)
{
    setScale(qreal(s) / 1000);
}

void ControlView::changeShear(int s)
{
    setShear(qreal(s) / 1000);
}

void ControlView::setShear(qreal s)
{
    m_shear = s;
    update();
}

void ControlView::setScale(qreal s)
{
    m_scale = s;
    update();
}
...
void ControlView::drawTextType(QPainter *painter)
{
    QPainterPath path;
...
void ControlView::drawVectorType(QPainter *painter)
{
    QPainterPath path;
